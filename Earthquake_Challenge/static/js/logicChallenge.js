...
// Create the Streets view tile layer that will be an option for the map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  // Radius is calculated using magnitude.
...
legend.onAdd = function() {
  ...
  // Creaye arrays for magnitutde and colors for magnitudes w/in the legend
